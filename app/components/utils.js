...
angular.module('utils', [])
    ...
    .service('RERUM', function ($cacheFactory, Lists, $http, $q, $sce) {
        var service = this;
        ...
        this.getResource = function (res) {
            ...
            if(index>-1){
                ...
                // already a resource?
            var hasValue = Lists.getAllByProp("@value", res, rcache)[0];
...
//                    if (type === "XML" || (defs[type].indexOf(b['@type']) > -1)) {
//                        var xml = new XMLHttpRequest();
//                        var deferred = $q.defer();
//                        xml.open('GET', b);
//                        xml.onreadystatechange = function () {
//                            if (xml.readyState === 4) {
//                                deferred.resolve($sce.trustAsHtml(xml.responseXML));
//                            }
//                        };
//                        xml.send();
