...
sounding.value('MANIFESTS', [
{
  ...
  "@context": "http://iiif.io/api/presentation/2/context.json",
        ...
        "metadata": [
            ...
            {"creator": "Henschel, Georg (1850-1934)"},
            {"contributor": "Tennyson, Lord Alfred (1809-1892)"},
            {"date": "1880"},
            {"source": "IMSLP, Petrucci Music Library"},
            {"subject": ["Henschel, Georg, 1850-1934—Composer.",
                    "Henschel, Georg, 1850-1934—Musical settings.",
            ...
            {"contributing institution": "http://imslp.org/wiki/Break,_Break,_Break_(Henschel,_George)"},
            {"publisher": "Sounding Tennyson"},
            {"rights": "This file is part of the Sibley Mirroring Project."},
            {"language": "English"},
            {"media type": "Musical Score"},
            {"type": "Music and Text"},
            {"resource identifier": "AET-MSS-1880-001-001"},
  ...
  "@context": "http://iiif.io/api/presentation/2/context.json",
  "@type": "sc:Manifest",
        "label": '“Break, Break, Break” Engraving',
  "description": '"Break, Break, Break”, music by Emily Tennyson, words by Alfred Tennyson, Engraving',
        "resources": ["Break_Break_Break_AET"],
        "metadata": [
            {"MEI Link": "http://165.134.241.141/sounding/data/Break_MEI.xml"},
            {"title": '"Break, Break, Break" Engraving'},
            {"creator": "Durazzi, Bruce"},
            {"contributor": ["Tennyson, Alfred Lord (1809-1892)", "Tennyson, Emily Lady (1813-1896)"]},
            {"date": "2015"},
            {"source": "Bruce Durazzi, Music Editor and Music Engraver"},
            {"subject": ["Tennyson, Emily Sellwood Tennyson, Baronness, 1813-1896—Musical settings.",
                    ...
                    "Poets, English—19th century.",
                    "Songs with piano—19th century."]},
            {"description": 'Engraving of musical score of "Break, Break, Break" by Bruce Durazzi, Music Editor and Music Engraver.'},
            {"website": "http://www.soundingtennyson.org"},
            {"publisher": "Sounding Tennyson"},
            {"language": "English"},
            {"media type": "Engraving"},
            {"type": "Music and Text"},
            {"resource identifier": "AET-MSS-2015-001"},
            {"digital collection (relation)": "Sounding Tennyson"},
            {"digital assistant": "Heather Bozant Witcher"}
        ],
  "layers": ["PianoLayer"],
...
sounding.value('ANNOTATIONS', [{
  ...
  "resource": "comment01",
        ...
        "on": [
            ...
            "@id": "line_5",
        "@type": "oa:Annotation", "resource": "publishedText#offset=124,155", // offset selector: start,end
        "on": [
            ...
            "@id": "line_6",
        "@type": "oa:Annotation", "resource": "publishedText#offset=156,195", // offset selector: start,end
        "on": [
            ...
            "@id": "line_7",
        "@type": "oa:Annotation", "resource": "publishedText#offset=196,222", // offset selector: start,end
        "on": [
            ...
            "@id": "line_8",
        "@type": "oa:Annotation", "resource": "publishedText#offset=223,260", // offset selector: start,end
        "on": [
            ...
            "@id": "line_9",
        "@type": "oa:Annotation", "resource": "publishedText#offset=262,289", // offset selector: start,end
        "on": [
            ...
            "@id": "line_10",
        "@type": "oa:Annotation", "resource": "publishedText#offset=290,320", // offset selector: start,end
        "on": [
            ...
            "@id": "line_11",
        "@type": "oa:Annotation", "resource": "publishedText#offset=321,360", // offset selector: start,end
        "on": [
            ...
            "@id": "line_12",
        "@type": "oa:Annotation", "resource": "publishedText#offset=361,400", // offset selector: start,end
        "on": [
            ...
            "@id": "line_13",
        "@type": "oa:Annotation", "resource": "publishedText#offset=402,422", // offset selector: start,end
        "on": [
            ...
            "@id": "line_14",
        "@type": "oa:Annotation", "resource": "publishedText#offset=423,455", // offset selector: start,end
        "on": [
            ...
            "@id": "line_15",
        "@type": "oa:Annotation", "resource": "publishedText#offset=456,498", // offset selector: start,end
        "on": [
            ...
            "@id": "line_16",
        "@type": "oa:Annotation", "resource": "publishedText#offset=499,526", // offset selector: start,end
        "on": [
